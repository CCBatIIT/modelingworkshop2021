...
[{% if module.slides == "ppt" %}[ppt](https://github.com/CCBatIIT/modelingworkshop2021/raw/main/slides/{{ module.basename }}.ppt)/{% elsif module.slides == "pdf"%}{% else %}[key](https://github.com/CCBatIIT/modelingworkshop2021/raw/main/slides/{{ module.basename }}.key)/{% endif -%}[pdf](https://github.com/CCBatIIT/modelingworkshop2021/raw/main/slides/{{ module.basename }}.pdf)].
